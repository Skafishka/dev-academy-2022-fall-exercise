    ...
    <>
      <h3>List of Journeys</h3>
        <h4>Please select the month:</h4>
          ...
          <Journeys 
            journeysMay={journeysMay} 
            month={month} 
            journeysJune={journeysJune} 
            journeysJuly={journeysJuly} 
            showFiltered={showFiltered} 
            handleFilterChange={handleFilterChange} 
          />
      <h3>List of Stations</h3>
        <h4>Add a new station: <AddStationForm addStation={addStation} newName={newName} handleNoteChange={handleNoteChange} newAddress={newAddress} handleAddressChange={handleAddressChange} /></h4>
        ...
        <h4>Please push the button to fetch a list of stations:</h4>
          ...
          <Stations 
            ...
            journeysJune={journeysJune} 
            journeysJuly={journeysJuly}
            handleSingleStation={handleSingleStation}
            count={count}
